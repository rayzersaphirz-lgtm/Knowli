...
document.getElementById('payer-btn').addEventListener('click', function() {
    // Redirige vers la nouvelle page d'animation
    window.location.href = 'animation-paiement.html';
});
